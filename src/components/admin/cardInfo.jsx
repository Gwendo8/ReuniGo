      ...
      {isVisible && (
        ...
        >
          <div className="bg-white p-4 sm:p-6 md:p-8 rounded-xl shadow-lg w-[75%] sm:w-[80%] md:max-w-2xl transition-transform transform hover:scale-105 max-h-[90vh] overflow-y-auto">
            <h2 className="text-xl md:text-3xl font-medium text-gray-800 mb-6 text-center flex items-center justify-center gap-2">
              <FaUser className="text-blue-600 hidden md:flex md:text-xl" />
